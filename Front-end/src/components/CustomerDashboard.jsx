    ...
    fetch("http://localhost:8082/packages/all")
      ...
      .then((data) => {
        ...
        if (data && data.length > 0) {
          ...
          // Show all packages from database, add images and locations from sample data if available
            ...
            .map((pkg) => {
              ...
              if (samplePkg) {
                ...
                return {
                  ...
                  image: "https://source.unsplash.com/400x200/?travel,india",
