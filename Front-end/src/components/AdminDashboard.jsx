...
function AdminDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      const [pendingRes, companiesRes, customersRes, bookingsRes, travellersRes] = await Promise.all([
        fetch("http://localhost:8080/admin/pending-companies"),
        fetch("http://localhost:8080/admin/all-companies"),
        fetch("http://localhost:8080/admin/all-customers"),
        fetch("http://localhost:8080/admin/bookings/all-with-details"),
        fetch("http://localhost:8080/admin/travellers/all-with-details")
      ]);
  ...
  const handleApproveCompany = async (userId) => {
    try {
      const response = await fetch(`http://localhost:8080/admin/approve-company/${userId}`, {
        method: "PUT",
  ...
  const handleRejectCompany = async (userId) => {
    try {
      const response = await fetch(`http://localhost:8080/admin/reject-company/${userId}`, {
        method: "PUT",
  ...
  const handleActivateCustomer = async (userId) => {
    try {
      const response = await fetch(`http://localhost:8080/admin/activate-customer/${userId}`, {
        method: "PUT",
  ...
  const handleDeactivateCustomer = async (userId) => {
    try {
      const response = await fetch(`http://localhost:8080/admin/deactivate-customer/${userId}`, {
        method: "PUT",
  ...
  const handleUpdatePaymentStatus = async (bookingId, newStatus) => {
    try {
      const response = await fetch(`http://localhost:8080/admin/bookings/update-payment-status/${bookingId}`, {
        method: "PUT",
        headers: {
  ...
  const handleTravellerClick = async (bookingId) => {
    try {
      const response = await fetch(`http://localhost:8080/admin/travellers/booking/${bookingId}/trips`, {
